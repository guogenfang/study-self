 ...
 */
(function (global, factory) {
	//在利用factory创建jQuery对象以前，首先进行window变量的检测。
	//jquery采用一个立即调用函数，判断是否是CommonJS规范
	//module 和 module.exports主要是为了让jQuery能够以模块的
	//形式注入到没有window.document变量的诸如Node.js的运行环境中，
	//当遇到这种情况，就不会在window中设置jQuery$变量。
	//要使用jQuery时，则是使用所返回的jQuery对象，如Node.js或者requiredJs,如在Node.js中：
	...
	if (typeof module === "object" && typeof module.exports === "object") {
		...
		//如果是requiredJS之类的，那么是不需要把jQuery对象作为全局变量的，
	...
	// Pass this if window is not defined yet
		...
		jQuery.extend = jQuery.fn.extend = function () {
			...
			options,
			clone,
			target = arguments[0] || {},//获取拓展jquery静态方法的对象{name: function(){}}
			i = 1,
		...
		// 如果noGlobal为null的话(反则为true)，为window全局变量添加$对象
